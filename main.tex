...
\item \textbf{Golem Network:} Primera supercomputadora descentralizada que crea un marktplace global de poder de computo.
...
\begin{center}
    ...
    3 & Investigación sobre métodos de encriptación & 40 \\
      & Desarrollo de modulo de encriptación de modelos de ML & 20 \\ \hline
      & Investigación sobre Federated Learning y alternativas & 40 \\ 
    ...
    5  & Pruebas del sistema en funcionamiento & 20 \\ \hline
      ...
      & Reuniones & 15 \\ \hline
    6  & Pruebas del sistema en funcionamiento & 20 \\ \hline
    7  & Pruebas del sistema en funcionamiento & 20 \\ \hline
    8  & Pruebas del sistema en funcionamiento & 20 \\ \hline
    9  & Pruebas del sistema en funcionamiento & 20 \\ \hline
    \end{tabularx}
\end{center}
}
...
\begin{center}
    ...
    Iteración 6 & 20 \\ \hline
    Iteración 7 & 20 \\ \hline
    Iteración 8 & 20 \\ \hline
    Iteración 9 & 20 \\ \hline
    Otros & 45 \\ \hline     
...
\begin{center}
    ...
    1 & Directorio con documentación util para el proyecto & Curso de aplicaciones descentralizadas terminado \\ \hline
