...
\section{Interacción entre modulos}
...
\section{Interacción entre participantes}
A continuación mostramos un diagrama del sistema y describimos cada una de las interacciones entre los diferentes participantes.
