...
El objetivo es aplicar los conocimientos adquiridos durante la carrera, debido a esto se optó por el tema \textbf{ \say{Machine Learning descentralizado utilizando Blockchain  para fomentar participaci\'on en la red}}. \\
